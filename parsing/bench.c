...
/*   Updated: 2026/03/09 13:47:51 by btheveny         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_bench(t_data *data)
{
	...
	ft_printf ("[bench] sa: %d, sb: %d, ss: %d, pa: %d, pb: %d\n",
		(int)data->sa_count, (int)data->sb_count, (int)data->ss_count,
		(int)data->pa_count, (int)data->pb_count);
	ft_printf("[bench] ra: %d, rb: %d, rr: %d, rra: %d, rrb: %d, rrr: %d\n",
		(int)data->ra_count, (int)data->rb_count, (int)data->rr_count,
		(int)data->rra_count, (int)data->rrb_count, (int)data->rrr_count);
}
